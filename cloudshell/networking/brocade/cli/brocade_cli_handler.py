...
from cloudshell.networking.brocade.cli.brocade_command_modes import EnableCommandMode, DefaultCommandMode, ConfigCommandMode
from cloudshell.networking.brocade.sessions.console_ssh_session import ConsoleSSHSession
from cloudshell.networking.brocade.sessions.console_telnet_session import ConsoleTelnetSession


class BrocadeCliHandler(CliHandlerImpl):
    def __init__(self, cli, resource_config, logger, api):
        super(BrocadeCliHandler, self).__init__(cli, resource_config, logger, api)
    ...
    def on_session_start(self, session, logger):
        ...
        session.hardware_expect("skip-page-display", EnableCommandMode.PROMPT, logger)

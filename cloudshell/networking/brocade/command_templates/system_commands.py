...
COPY_TO_SECONDARY = CommandTemplate("copy {scheme} flash {host} {file_path} secondary delete-first", action_map=ACTION_MAP)
BOOT_SECONDARY = CommandTemplate("boot system flash secondary", action_map=ACTION_MAP)
COMMIT_FIRMWARE = CommandTemplate("copy flash flash primary delete-first", action_map=ACTION_MAP)
